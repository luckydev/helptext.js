...
helptext.js is a small jQuery plugin to label the form input elements inside their container itself. Look at the demo for example. It can eliminate using labels in the forms.
